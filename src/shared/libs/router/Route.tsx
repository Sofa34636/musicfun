...
// ЕГО задача отслеживать адресную строку браузера и  если она поменяется я срвню ее с  путем путем который у меня указа я отрисую  компонент, а  если нет то  я  удалю компонент
export const Route = (props: any) => { // отвечает  за отслеживание  строки  браузера
...
export const NavLink = (props) => {  // отвечает  за  смену адреса
